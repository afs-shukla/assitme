from scripts_bot import intent_classifier
from scripts_bot import entity_classifier1
from scripts_bot import entity_classifier2
from scripts_bot import code_classify
import json
import nltk
...
def des_sol(question,intent):
        ...
        print("Out Put of entity Classifier 1  ====== ",entity)
        if entity is None:
           entity=entity_classifier2.entity(question)
           print("Out Put of entity Classifier 2 ===== ",entity)
      
        read_file = open("datasets/info_solution.json","r",encoding='UTF8')
